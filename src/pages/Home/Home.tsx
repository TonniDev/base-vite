...
export const Home = () => {
  ...
  return (
    <>
      <header className="text-dark dark:text-light bg-gray-100 dark:bg-gray-900 sticky top-0 right-0 left-0 z-15 flex h-fit w-full items-center justify-between px-32 py-4 font-medium sm:px-8 md:px-12 lg:px-16">
