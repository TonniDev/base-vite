...
function ThemeSwitcher() {
  ...
  return (
    <div className="theme-switcher ml-12 items-center text-black dark:text-white">
      <button
        type="button"
        className={`dark-mode-switch mr-6 h-[40px] w-[40px] cursor-pointer rounded-[100%] border p-[10px] ${!isLight && "hidden"}`}
        onClick={setDarkTheme}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
          className="bi bi-moon-stars-fill h-[18px] w-[18px]"
          viewBox="0 0 16 16">
      ...
      <button
        type="button"
        className={`light-mode-switch mr-6 h-[40px] w-[40px] cursor-pointer rounded-[100%] border p-[10px] ${isLight && "hidden"}`}
